	...
	<body style="background-image: url('img/saved.jpg');">
		<?php
			...
			else
			{
				...
				echo "<center><legend style='color:crimson;'><b> Pending Membership Registration</b></legend></center>";
				...
				echo "<input type='submit' value='Confirm Verification' name='l_confirm' style='background:crimson;' />&nbsp;&nbsp;&nbsp;";
				echo "<input type='submit' value='Reject' name='l_delete' style='background:crimson;' />";
				echo "</div>";
				echo "</form>";
			}
