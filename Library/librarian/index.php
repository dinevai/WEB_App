...
<html>
	...
	<body style="background-image: url('img/opacity.png');">
		...
		<center><legend style="color:crimson;"><b>Librarian Login</b></legend></center>
			...
			<input type="submit" value="Login" name="l_login" style="background:crimson;"/>

			
			
		</form>
		<p align="center"><a href="../index.php" style="text-decoration:none; color:crimson;"><b>Go Back</b></a>
	</body>
