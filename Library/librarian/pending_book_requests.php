...
<html>
	...
	<body style="background-image: url('img/saved.jpg');">
		<?php
			...
			if($rows == 0)
				echo "<h2 align='center' style='color:crimson;'>No requests pending</h2>";
			else
			{
				echo "<form class='cd-form' method='POST' action='#'>";
				echo "<center><legend style='color:crimson;'><b>Pending book requests</b></legend></center>";
				...
				echo "<input type='submit' value='Reject Request' name='l_reject' style='background:crimson' />&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "<input type='submit' value='Allow' name='l_grant' style='background:crimson' />";
				echo "</div>";
				echo "</form>";
			}
