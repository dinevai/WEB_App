...
<html>
	...
	<body style="background-image: url('img/opacity.png');">
		...
		<?php
			...
			if($rows == 0)
				echo "<h2 align='center' style='color:crimson;'>There Are No Issued Books Yet!</h2>";
			else
			{
				echo "<form class='cd-form' method='POST' action='#'>";
				echo "<center><legend style='color:crimson;'>My Books</legend></center>";
				...
				echo "</table><br />";
				echo "<input type='submit' name='b_return' value='Return Selected Books' style='background:crimson' />";
				echo "</form>";
			}
