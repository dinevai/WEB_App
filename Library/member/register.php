...
<html>
	...
	<body style="background-image: url('img/opacity.png');">
		<form class="cd-form" method="POST" action="#">
			<center><legend style='color:crimson;'><b>Member Registration</b></legend>
			<p style='color:crimson;'><b>Please fillup the form below if you want 
				to register on this platform as a MEMBER:</b></p></center>
				...
				<div class="icon">
					<input class="m-balance" type="number" name="m_balance" id="m_balance" placeholder="Initial E-Points" required 
					style='background-color:white;' />
				</div>
				<p style="background:crimson; color:white;">If you are sure that you want to submit your
			application click on the SUBMIT button below this text!</p>
				<br />
				<input type="submit" name="m_register" value="Submit" style="background: crimson" />
		</form>
	</body>
