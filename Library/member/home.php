	...
	<body style="background-image: url('img/saved.jpg');">
		<?php
			...
			else
			{
				...
				echo "<center><legend style='color:crimson;'><b>List of Available Books</b></legend></center>";
				...
				echo "</table>";
				echo "<br /><br /><input type='submit' name='m_request' value='Request Book' style='background:crimson' />";
				echo "</form>";
			}
